...
class WorkDayBinarySensor(CoordinatorEntity, BinarySensorEntity):
    ...
    def __init__(self, coordinator: CalendarCoordinator, entries: list[CalendarEntry]) -> None:
        """Initialise sensor."""
    ...
    def _handle_coordinator_update(self) -> None:
        ...
        self.entries = self.coordinator.get_calendar_entries_by_fullname(
            self.coordinator.fullname
        )
    ...
    def is_on(self) -> bool | None:
        ...
        matching_entries = [
            ...
            if entry.event_date <= now <= entry.end_date and entry.category in holiday_types
        ]
